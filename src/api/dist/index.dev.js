...
var _default = (_getLoginCellphone$ge = {
  ...
  getTopMv: function getTopMv(parameter) {
    // mv排行
  ...
  getMvDetail: function getMvDetail(parameter) {
    // 获取mv数据
  ...
  getMvDetailInfo: function getMvDetailInfo(parameter) {
    // 获取mv点赞转发评论数数据
  ...
  getMvUrl: function getMvUrl(parameter) {
    // mv地址
   ...
   */
}), _defineProperty(_getLoginCellphone$ge, "getHomepageBlockPage", function getHomepageBlockPage(parameter) {
  // 首页-发现
   ...
   * 说明:调用此接口,可获取APP首页信息
   */
}), _defineProperty(_getLoginCellphone$ge, "getHomepageDragonBall", function getHomepageDragonBall(parameter) {
  // 首页-发现-圆形图标入口列表
