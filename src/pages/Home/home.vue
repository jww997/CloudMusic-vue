  ...
  <div class="container">
    <div class="topBar">
      ...
      <div class="topBar-pagination">
        <div class="swiper-slide-visible topBar-pagination-item"
          :class="homeSwiperIndex == index? 'topBar-pagination-item-active': ''" v-for="(item,index) in homeSwiperItems"
          :key="index" @click="toggleHomeSwiperIndex" :data-id="index">{{item}}</div>
      </div>
