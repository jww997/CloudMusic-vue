...
var _default = (_getLoginCellphone$ge = {
   ...
   */
}), _defineProperty(_getLoginCellphone$ge, "getDjBanner", function getDjBanner(parameter) {
  // 电台banner
  return request("dj/banner", parameter);
  /**
   * 说明:调用此接口,可获取电台banner
   */
}), _defineProperty(_getLoginCellphone$ge, "getDjPersonalizeRecommend", function getDjPersonalizeRecommend(parameter) {
  // 电台个性推荐
   ...
   */
}), _defineProperty(_getLoginCellphone$ge, "getDjSubscriber", function getDjSubscriber(parameter) {
  // 电台订阅者列表
   ...
   */
}), _defineProperty(_getLoginCellphone$ge, "getUserAudior", function getUserAudior(parameter) {
  // 用户电台
   ...
   */
}), _defineProperty(_getLoginCellphone$ge, "getDjHot", function getDjHot(parameter) {
  // 热门电台
   ...
   * 说明:调用此接口,可获取热门电台
   */
}), _defineProperty(_getLoginCellphone$ge, "getDjProgramToplist", function getDjProgramToplist(parameter) {
  // 电台-节目榜
   ...
   */
}), _defineProperty(_getLoginCellphone$ge, "getDjToplistPay", function getDjToplistPay(parameter) {
  // 电台-付费精品
   ...
   * 说明:调用此接口,可获取付费精品电台
   */
}), _defineProperty(_getLoginCellphone$ge, "getDjProgramToplistHours", function getDjProgramToplistHours(parameter) {
  // 电台-24小时节目榜
   ...
   * 说明:调用此接口,可获取24小时节目榜
   */
}), _defineProperty(_getLoginCellphone$ge, "getDjToplistHours", function getDjToplistHours(parameter) {
  // 电台-24小时主播榜
   ...
   * 说明:调用此接口,可获取24小时主播榜
   */
}), _defineProperty(_getLoginCellphone$ge, "getDjToplistNewcomer", function getDjToplistNewcomer(parameter) {
  // 电台-主播新人榜
   ...
   * 说明:调用此接口,可获取主播新人榜
   */
}), _defineProperty(_getLoginCellphone$ge, "getDjToplistPopular", function getDjToplistPopular(parameter) {
  // 电台-最热主播榜
   ...
   * 说明:调用此接口,可获取最热主播榜
   */
}), _defineProperty(_getLoginCellphone$ge, "getDjToplist", function getDjToplist(parameter) {
  // 电台-新晋电台榜/热门电台榜
   ...
   */
}), _defineProperty(_getLoginCellphone$ge, "getDjRadioHot", function getDjRadioHot(parameter) {
  // 电台-类别热门电台
   ...
   * 说明:登录后调用此接口,可获得新晋电台榜/热门电台榜
   */
}), _defineProperty(_getLoginCellphone$ge, "getDjRecommend", function getDjRecommend(parameter) {
  // 电台-推荐
  return request("dj/recommend", parameter);
  /**
   * 说明:登录后调用此接口,可获得推荐电台
   */
}), _defineProperty(_getLoginCellphone$ge, "getDjCatelist", function getDjCatelist(parameter) {
  // 电台-分类
  return request("dj/catelist", parameter);
  /**
   * 说明:登录后调用此接口,可获得电台类型
   */
}), _defineProperty(_getLoginCellphone$ge, "getDjRecommendType", function getDjRecommendType(parameter) {
  // 电台-分类推荐
   ...
   */
}), _defineProperty(_getLoginCellphone$ge, "getDjSub", function getDjSub(parameter) {
  // 电台-订阅
   ...
   */
}), _defineProperty(_getLoginCellphone$ge, "getDjSublist", function getDjSublist(parameter) {
  // 电台的订阅列表
  return request("dj/sublist", parameter);
  /**
   * 说明:登录后调用此接口,可获取订阅的电台列表
   */
}), _defineProperty(_getLoginCellphone$ge, "getDjPaygift", function getDjPaygift(parameter) {
  // 电台-付费精选
   ...
   */
}), _defineProperty(_getLoginCellphone$ge, "getDjCategoryExcludehot", function getDjCategoryExcludehot(parameter) {
  // 电台-非热门类型
  return request("dj/category/excludehot", parameter);
  /**
   * 说明:登录后调用此接口,可获得电台非热门类型
   */
}), _defineProperty(_getLoginCellphone$ge, "getDjCategoryRecommend", function getDjCategoryRecommend(parameter) {
  // 电台-推荐类型
  return request("dj/category/recommend", parameter);
  /**
   * 说明:登录后调用此接口,可获得电台推荐类型
   */
}), _defineProperty(_getLoginCellphone$ge, "getDjTodayPerfered", function getDjTodayPerfered(parameter) {
  // 电台-今日优选
  return request("dj/today/perfered", parameter);
  /**
   * 说明:登录后调用此接口,可获得电台今日优选
   */
}), _defineProperty(_getLoginCellphone$ge, "getDjDetail", function getDjDetail(parameter) {
  // 电台-详情
   ...
   */
}), _defineProperty(_getLoginCellphone$ge, "getDjProgram", function getDjProgram(parameter) {
  // 电台-节目
   ...
   */
}), _defineProperty(_getLoginCellphone$ge, "getDjProgramDetail", function getDjProgramDetail(parameter) {
  // 电台-节目详情
